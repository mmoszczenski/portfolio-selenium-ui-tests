...
class SignUpStep2(BasePage):
    ...
    def mark_newsletter_checkbox(self) -> None:
        self.click(self._NEWSLETTER_CHECKBOX)
        
    def mark_special_offers_checkbox(self) -> None:
    ...
    def fill_address2(self, text: str) -> None:
    ...
    def fill_mobile_number(self, text: str) -> None:
    ...
    def fill_account_information_form(
        self, country: str, first_name: str, last_name: str, address: str, state: str, city: str, zipcode: str, mobile_number: str, password: str | None = None, **kwargs
    ) -> None:
